...
${OBJECTDIR}/_ext/1360920745/bmc.o: ../bmc/bmc.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g `pkg-config --cflags xaw7` `pkg-config --cflags comedilib`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360920745/bmc.o ../bmc/bmc.c

${OBJECTDIR}/_ext/1685954798/daq.o: ../bmc/bmc/daq.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1685954798
	${RM} "$@.d"
	$(COMPILE.c) -g `pkg-config --cflags xaw7` `pkg-config --cflags comedilib`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1685954798/daq.o ../bmc/bmc/daq.c

${OBJECTDIR}/_ext/1181056713/bmcnet.o: ../bmc/bmc_x86/bmcnet.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1181056713
	${RM} "$@.d"
	$(COMPILE.c) -g `pkg-config --cflags xaw7` `pkg-config --cflags comedilib`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1181056713/bmcnet.o ../bmc/bmc_x86/bmcnet.c
